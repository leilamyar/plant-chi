<main class="spot-choice-c">
  ...
  <div id="plantchi-img-neutral" class="plantchi-speaks-flex-c">
    <img src="public/images/plant-chi/plant-chi_neutral.png" alt="Plant-chi gives instructions">
    <p class="plantchi-text">Choose the right spot for me &#60;3 </p>
  </div>
  <div id="plantchi-img-unhappy" class="plantchi-speaks-flex-c hidden">
    <img src="public/images/plant-chi/plant-chi_unhappy.png" alt="Plant-chi is unhappy">
    <p class="plantchi-text">Choose the right spot for me &#60;3 </p>
  </div>
  <div id="plantchi-img-happy" class="plantchi-speaks-flex-c hidden">
    <img src="public/images/plant-chi/plant-chi_happy.png" alt="Plant-chi is happy">
    <p class="plantchi-text">Choose the right spot for me &#60;3 </p>
  </div>
  <!-- COLUMN 2 = room img -->
  <section class="body">
